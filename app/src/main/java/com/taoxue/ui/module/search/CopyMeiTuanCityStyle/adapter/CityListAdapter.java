...
public class CityListAdapter extends BaseAdapter {
    ...
    public CityListAdapter(Context mContext, List<City> mCities,boolean isHaveLoc) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        switch (viewType){
            case 0:     //定位
                ...
                view.findViewById(R.id.tv_query_all_result).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (onCityClickListener != null){
                            onCityClickListener.onQueryAllResultClick();
                        }
                    }
                });
                switch (locateState){
                ...
                container.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (locateState == LocateState.FAILED){
                            //重新定位
                            if (onCityClickListener != null){
                                onCityClickListener.onLocateClick(locatedCity);
                            }
...
//                        if (onCityClickListener != null){
//                            onCityClickListener.onHotCityClick(hotCityGridAdapter.getItem(position));
//                           updateLocateState(LocateState.SUCCESS,hotCities.get(position));
//                        }
//                    }
//                });
//                break;
    ...
    public interface OnCityClickListener{
        ...
        void onLocateClick(String cityName);
        void onQueryAllResultClick();
    }
}
